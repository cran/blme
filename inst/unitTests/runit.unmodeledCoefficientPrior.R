...
test.blme.parsePrior.fixef.prior <- function()
{
  ...
  prior <- blme:::parsePrior(model1, fixef.prior = "normal(data.scale = 'absolute')");
  {
    ...
    checkEquals(prior@families[1], blme:::getEnumOrder(blme:::familyEnumeration, "normal"));
  }

  prior <- blme:::parsePrior(model1, fixef.prior = "normal(1.5)");
  {
    checkEquals(prior@type, blme:::getEnumOrder(blme:::typeEnumeration, "direct"));
    checkEquals(length(prior@families), 1);
    checkEquals(length(prior@scales), 1);
  ...
  prior <- blme:::parsePrior(model1, fixef.prior = "normal(1.5, 'common')");
  {
    checkEquals(prior@type, blme:::getEnumOrder(blme:::typeEnumeration, "direct"));
    checkEquals(length(prior@families), 1);
    checkEquals(length(prior@scales), 1);
    ...
    checkEquals(prior@families[1], blme:::getEnumOrder(blme:::familyEnumeration, "normal"));
    checkEquals(prior@hyperparameters, c(2.0 * 2.0 * log(1.5), 1 / 1.5));
    checkEquals(prior@scales[1], blme:::getEnumOrder(blme:::scaleEnumeration, "common"));
  }

  prior <- blme:::parsePrior(model1, fixef.prior = "normal(diag(2), cov.scale = 'common')");
  {
    checkEquals(prior@type, blme:::getEnumOrder(blme:::typeEnumeration, "direct"));
    checkEquals(length(prior@families), 1);
    checkEquals(length(prior@scales), 1);
  ...
  prior <- blme:::parsePrior(model1, fixef.prior = "normal(cov = testCovariance, cov.scale = 'absolute')");
  {
    ...
    checkEquals(prior@scales[1], blme:::getEnumOrder(blme:::scaleEnumeration, "absolute"));
  }
  
  prior <- blme:::parsePrior(model1, fixef.prior = "normal(cov = c(1.1, 0.9))");
  {
    checkEquals(prior@type, blme:::getEnumOrder(blme:::typeEnumeration, "direct"));
    checkEquals(length(prior@families), 1);
    checkEquals(length(prior@scales), 1);
  ...
  prior <- blme:::parsePrior(model1, fixef.prior = "normal(sd = 1.2, data.scale = 'free')");
  {
    checkEquals(prior@type, blme:::getEnumOrder(blme:::typeEnumeration, "direct"));
    checkEquals(length(prior@families), 1);
    checkEquals(length(prior@scales), 1);
  ...
  checkException(blme:::parsePrior(model1, fixef.prior = "normal(cov.scale = 'crazy')"));
